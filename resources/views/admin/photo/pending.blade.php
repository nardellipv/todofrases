...
@section('content')
    ...
    <div class="panel-body">
        ...
        <a href="{{ url('photoPending') }}" data-toggle="modal" class="btn btn-warning disabled" disabled>
    ...
    <div class="gallery">
        <h2 class="w3ls_head">Imágenes Pendientes</h2>
        <div class="gallery-grids">

            @foreach($photosPending as $photo)
