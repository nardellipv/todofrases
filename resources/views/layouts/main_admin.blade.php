...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backStyle/css/morris.css') }}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{ asset('backStyle/css/monthly.css') }}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
...
<!-- calendar -->
<script type="text/javascript" src="{{ asset('backStyle/js/monthly.js') }}"></script>
